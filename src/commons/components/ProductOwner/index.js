                  ...
                  myProductArr.map((data, idx) => (
                    <section className={`${styles["main-section"]} row`} key={idx}>
                      <div className={`${styles["image-card"]} col-md-2`}>
                        <Image
                          src={!data.image[0] ? defaultProduct : !data.image[0].image ? defaultProduct : data.image[0].image}
                          height={172}
                          width={170}
                          placeholder="blur"
                      ...
                      <div
                        className={`${styles["button-delete"]} col-md-3 btn`}
                        onClick={() => {
                          Swal.fire({
